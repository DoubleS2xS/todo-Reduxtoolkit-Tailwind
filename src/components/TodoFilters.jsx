...
export default ( {currentFilter, stats, onFilterChange } ) => {
  const filters = [
    ...
    <div className="flex items-center justify-center">
      <div className="inline-flex bg-gray-200 rounded-lg p-1">
        ...
        {filters.map(({key,label,icon :Icon, count}) => {
          return(
          <button className={`flex items-center gap-2 px-2 py-2 rounded-md text-sm font-medium transition-all duration 200 ${currentFilter === key 
